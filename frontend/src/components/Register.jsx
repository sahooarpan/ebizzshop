...
const Register = ({history}) => {
    ...
    return (
        ...
        <div class="form-group">
            ...
            placeholder="Enter name" required name="name" value={name}  onChange={e=>setName(e.target.value)} />
        </div>
        <div className="form-group">
            ...
            <input type="password" class="form-control"
             id="confirmPassword" name="confirmPassword"
              placeholder="Confirm Password" required value={confirmPassword} 
            ...
            <button disabled={name === "" ||
                email === "" ||
                password === "" ||
                confirmPassword === "" ||passwordErrorMessage !== ""} type="submit" class="btn btn-primary px-3">Submit</button>
            <p className="form-text">Have an account ? <Link className="form-link" to="/signin">Please login </Link>here.</p>
        </form>
        </div>  
    )
}
